...
It's a social flutter application that offer the user to share shop photos & recipes with his followers by using firebase firestore as backend , you can upload posts , search for other users , like & unlike their posts and receives notifications .
